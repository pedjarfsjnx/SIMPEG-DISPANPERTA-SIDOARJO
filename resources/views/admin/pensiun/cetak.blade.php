        ...
        <div class="report-title">
            ...
            <div class="report-meta editable-field" contenteditable="true" title="Klik untuk mengedit periode/keterangan laporan">
                @if($tahunMulai && $tahunSelesai && $tahunMulai == $tahunSelesai)
                    Tahun Proyeksi: <strong>{{ $tahunMulai }}</strong>
                @elseif($tahunMulai && $tahunSelesai)
                    Rentang Tahun Proyeksi: <strong>Tahun {{ min($tahunMulai, $tahunSelesai) }} s.d. {{ max($tahunMulai, $tahunSelesai) }}</strong>
                @elseif($tahunMulai)
                    Proyeksi: <strong>Mulai Tahun {{ $tahunMulai }}</strong>
                @elseif($tahunSelesai)
                    Proyeksi: <strong>Sampai Tahun {{ $tahunSelesai }}</strong>
