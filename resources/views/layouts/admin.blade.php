...
<body class="bg-slate-100 text-slate-800 antialiased flex flex-col md:flex-row min-h-screen" x-data="{ mobileMenuOpen: false }">
    ...
    <div class="flex-grow flex flex-col min-w-0 overflow-hidden w-full">
        <!-- Topbar -->
        <header class="bg-white border-b border-slate-200 py-3 px-4 sm:px-6 flex items-center justify-between shadow-xs">
        ...
        <!-- Content Area -->
        <main class="flex-grow p-3 sm:p-6 overflow-y-auto">
            @yield('content')
        </main>
    </div>
