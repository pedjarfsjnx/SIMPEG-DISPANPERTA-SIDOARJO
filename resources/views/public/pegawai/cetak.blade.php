...
<head>
    ...
    <style>
        ...
        .kop h3 { margin: 2px 0; font-size: 14px; text-transform: uppercase; }
...
<body>
    ...
    <div class="kop">
        ...
        <p>Jl. Erlangga No. 1 Sidoarjo, Jawa Timur | Telp. (031) 8921820 | Email: dispanperta@sidoarjokab.go.id</p>
    </div>
    ...
    <div style="margin-top: 30px; float: right; text-align: center; width: 250px;">
        ...
        <br><br><br>
        <p><strong>Ir. MOKHAMAD RUDY AL AMIN</strong><br>Pembina Utama Muda<br>NIP. 196712101997032004</p>
    </div>
