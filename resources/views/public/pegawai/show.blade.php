...
<div class="max-w-4xl mx-auto space-y-5 text-xs">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div class="bg-white rounded-lg border border-slate-200 p-5 space-y-4 shadow-sm">
            ...
            <div>
                <label class="text-slate-400 block text-[11px]">Unit Kerja Utam</label>
        ...
        <div class="bg-white rounded-lg border border-slate-200 p-5 space-y-4 shadow-sm">
            <h3 class="text-xs font-bold uppercase tracking-wider text-slate-500 border-b border-slate-100 pb-2">Informasi Umum</h3>
            ...
            <div>
                <label class="text-slate-400 block text-[11px]">TMT Jabatan</label>
                <p class="font-semibold text-slate-900 text-sm">
